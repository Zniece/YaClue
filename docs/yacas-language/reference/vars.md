...
The `:=` operator can be used in a number of ways. In all
...
the assignment and the result of the assignment is `True`.  The
...
> **See also:** [Set](vars.md#setvar-exp), [Clear](vars.md#clearvar), `[]`, `Rule`, [Infix](programming-language.md#infixop-precedence), [Eval](controlflow.md#evalexpr), `Function`
...
> **See also:** [Clear](vars.md#clearvar), `:=`
...
> **See also:** [Set](vars.md#setvar-exp), `:=`
...
[Prog](programming-language.md#progexpr1-expr2) block (or its syntactic equivalent, the `[]`
...
with [UnFence](programming-language.md#unfenceoperator-arity).
...
> **See also:** `LocalSymbols`, [Prog](programming-language.md#progexpr1-expr2), `[]`, [UnFence](programming-language.md#unfenceoperator-arity)
...
This function returns "obj" as soon as "pred" returns `True` when
...
> **See also:** [IsNonObject](predicates.md#isnonobjectexpr)
...
[SetGlobalLazyVariable](vars.md#setgloballazyvariablevarvalue) enforces that a global variable will
...
immediately returns the result.  [SetGlobalLazyVariable](vars.md#setgloballazyvariablevarvalue) is
...
> **See also:** [Set](vars.md#setvar-exp), [Clear](vars.md#clearvar), [Local](vars.md#localvar), [%](consts.md#), `I`
...
### bodied LocalSymbols(expr, var1, var2, ...)
...
`LocalSymbols`, a set of unique local symbols will be
...
in the macro-like functions (`For`, `While` etc.).
...
> **See also:** [UniqueConstant](vars.md#uniqueconstant)
