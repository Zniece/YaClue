...
This material descends from the upstream [Yacas project](http://www.yacas.org/).
The link is retained for historical attribution; current build and usage
...
Roberto Colistete Junior
    Is maintaining a version of [Yacas for SymbianOS](http://www.robertocolistete.net/Yacas/).
...
Gabor Grothendieck
    Gabor is the maintainer of [Ryacas](https://code.google.com/p/ryacas/), and gave valuable feedback on the
    new web site.
...
Wolfgang Hšnig               *pocket_software "AT" web "DOT" de*
    Created a port of Yacas that runs on PocketPC, to be found [here](http://www.pocket-software.de.vu).
