...
import type { LatexSyntaxError, MacroDictionary, Offset, ParseMode, Registers, Style, Selection, Range, OutputFormat, YaClueConversionResult, YaClueSubmissionResult, ElementInfo, InsertOptions } from './core-types';
...
export declare class MathfieldElement extends HTMLElement implements Mathfield {
    ...
    */
    ...
    /** Convert the complete field to YaClue and return structured diagnostics. */
    getYaClueConversionResult(): YaClueConversionResult;
    /** Convert the field using the one-shot `expression; assumptions` protocol. */
    getYaClueSubmissionResult(): YaClueSubmissionResult;
    /**
