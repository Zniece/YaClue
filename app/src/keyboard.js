...
export const YACLUE_KEY_SEMANTICS = Object.freeze({
  ...
  nthDerivative: { keycap: '\\frac{\\mathrm{d}^{n}}{\\mathrm{d}x^{n}}', class: 'small', latex: '\\yaclueNthDerivative{x}{#0}{#@}', yaclue: 'D(x,n)expr' },
  integral: { keycap: '\\int', class: 'integral-key', latex: '\\yaclueIntegral{x}{#@}', yaclue: 'Integrate(x)expr' },
  definiteIntegral: { keycap: '\\int_{a}^{b}', class: 'integral-key', latex: '\\yaclueDefiniteIntegral{x}{#0}{#0}{#@}', yaclue: 'Integrate(x,a,b)expr' },
  limit: { keycap: '\\lim', latex: '\\yaclueLimit{x}{#0}{#@}', yaclue: 'Limit(x,a)expr' },
  sum: { keycap: '\\sum', latex: '\\yaclueSum{k}{#0}{#0}{#@}', yaclue: 'Sum(k,a,b,expr)' },
  ...
  partial: { keycap: '\\frac{\\partial}{\\partial x}', class: 'small', latex: '\\yacluePartialDerivative{x}{#@}', yaclue: 'D(x)expr' },
