...
export const YACLUE_KEY_SEMANTICS = Object.freeze({
  ...
  derivative: { keycap: '\\frac{\\mathrm{d}}{\\mathrm{d}x}', class: 'small', latex: '\\yaclueDerivative{x}{#0}', yaclue: 'D(x)expr' },
  nthDerivative: { keycap: '\\frac{\\mathrm{d}^{n}}{\\mathrm{d}x^{n}}', class: 'small', latex: '\\yaclueNthDerivative{x}{#0}{#0}', yaclue: 'D(x,n)expr' },
  integral: { keycap: '\\int', class: 'integral-key', latex: '\\yaclueIntegral{x}{#0}', yaclue: 'Integrate(x)expr' },
  definiteIntegral: { keycap: '\\int_{a}^{b}', class: 'integral-key', latex: '\\yaclueDefiniteIntegral{x}{#0}{#0}{#0}', yaclue: 'Integrate(x,a,b)expr' },
  limit: { keycap: '\\lim', latex: '\\yaclueLimit{x}{#0}{#0}', yaclue: 'Limit(x,a)expr' },
  sum: { keycap: '\\sum', latex: '\\yaclueSum{k}{#0}{#0}{#0}', yaclue: 'Sum(k,a,b,expr)' },
  ...
  leftLimit: { keycap: '\\lim^-', latex: '\\yaclueLeftLimit{x}{#0}{#0}', yaclue: 'Limit(x,a,Left)expr' },
  rightLimit: { keycap: '\\lim^+', latex: '\\yaclueRightLimit{x}{#0}{#0}', yaclue: 'Limit(x,a,Right)expr' },
  taylor: { label: 'Taylor', latex: '\\yaclueTaylor{x}{#0}{#0}{#0}', yaclue: 'Taylor(x,a,n)expr' },
  substitute: { label: 'Subst', latex: '\\yaclueSubstitute{x}{#0}{#0}', yaclue: 'Subst(x,replacement)expr' },
  doubleIntegral: { keycap: '\\iint', class: 'integral-key', latex: '\\yaclueDoubleIntegral{x}{#0}{#0}{y}{#0}{#0}{#0}', yaclue: 'DoubleIntegral(expr,x,a,b,y,c,d)' },
  polarIntegral: { keycap: '\\iint_{\\mathrm{pol}}', class: 'integral-key', latex: '\\yacluePolarIntegral{x}{y}{r}{\\theta}{#0}{#0}{#0}{#0}{#0}', yaclue: 'PolarIntegral(expr,x,y,r,theta,r0,r1,t0,t1)' },
  infinity: { keycap: '\\infty', latex: '\\infty', yaclue: 'Infinity' },
  principalValue: { keycap: '\\operatorname{PV}\\!\\int', class: 'integral-key', latex: '\\yacluePrincipalValueIntegral{x}{#0}{#0}{#0}', yaclue: 'PrincipalValueIntegral(expr,x,a,b)' },
  partial: { keycap: '\\frac{\\partial}{\\partial x}', class: 'small', latex: '\\yacluePartialDerivative{x}{#0}', yaclue: 'D(x)expr' },
...
const yaclueCalculusPlusKeyboard = makeKeyboard('calculus-plus', 'Calc+', 'Advanced calculus', [
  ...
  'doubleIntegral', 'polarIntegral', 'infinity', 'principalValue', semanticKey('sum'),
