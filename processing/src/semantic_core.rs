...
pub struct OperatorDescriptor {
    ...
    /// Type-checked bridge to the existing domain operation. The handler
    /// extracts a request and delegates; domain algorithms do not live in the
    /// registry.
...
pub const OPERATOR_DESCRIPTORS: &[OperatorDescriptor] = &[
    OperatorDescriptor {
        ...
        execution_handler: crate::arithmetic::execute_calculus_adapter,
    ...
    OperatorDescriptor {
        ...
        execution_handler: crate::arithmetic::execute_algebra_transform_adapter,
    ...
    OperatorDescriptor {
        ...
        execution_handler: crate::arithmetic::execute_substitution_adapter,
    ...
    OperatorDescriptor {
        ...
        execution_handler: crate::arithmetic::execute_taylor_adapter,
        product_kind: "taylor",
        title: "Taylor 多项式",
    },
    OperatorDescriptor {
        ...
        execution_handler: crate::arithmetic::execute_equation_solve_adapter,
    ...
    OperatorDescriptor {
        ...
        execution_handler: crate::arithmetic::execute_matrix_unary_adapter,
        product_kind: "matrix",
        title: "线性代数",
    },
    OperatorDescriptor {
        ...
        execution_handler: crate::arithmetic::execute_matrix_solve_adapter,
        product_kind: "matrix",
        title: "线性方程组",
    },
    OperatorDescriptor {
    ...
    OperatorDescriptor {
        ...
        execution_handler: crate::arithmetic::execute_factor_projection_adapter,
        product_kind: "matrix",
        title: "矩阵因子",
    },
    OperatorDescriptor {
        ...
        execution_handler: crate::arithmetic::execute_ode_solve_adapter,
        product_kind: "ode",
        title: "常微分方程",
    },
    OperatorDescriptor {
        ...
        execution_handler: crate::arithmetic::execute_approximate_adapter,
    ...
    OperatorDescriptor {
        ...
        execution_handler: crate::arithmetic::execute_series_adapter,
        product_kind: "series",
        title: "级数",
    },
    OperatorDescriptor {
    ...
    OperatorDescriptor {
        ...
        execution_handler: crate::arithmetic::execute_numeric_ode_adapter,
    ...
    OperatorDescriptor {
        ...
        execution_handler: crate::arithmetic::execute_numeric_root_adapter,
    ...
    OperatorDescriptor {
        ...
        execution_handler: crate::arithmetic::execute_plot_effect_adapter,
        product_kind: "plot",
        title: "函数图像",
    },
    OperatorDescriptor {
    ...
    OperatorDescriptor {
        ...
        execution_handler: crate::arithmetic::execute_multivariate_adapter,
    ...
    OperatorDescriptor {
        ...
        execution_handler: crate::arithmetic::execute_line_integral_adapter,
    ...
    OperatorDescriptor {
        ...
        execution_handler: crate::arithmetic::execute_surface_integral_adapter,
